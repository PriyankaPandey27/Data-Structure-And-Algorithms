...
//        array[d].head=newNode;
    ...
    public void BFS(int source ,int destination)
    {
        ...
        // AdjList p=array[source];
         ...
         AdjListNode temp=array[source].head;
...
// DFS traversal of the vertices reachable from v. It uses recursive DFSUtil()
    public void DFS(int v ,int t)
    {
        ...
        //Disconnected graph where all vertices cant be reachable from a given vertex
//        for(int j=0;j<V;j++)
//        {
//           // System.out.println("visited j "  + visited[j]+ " for j " + j);
//            if(visited[j]==false)
//            {
//               // System.out.println("v inside dfs " + j);
//               DFSUtil(j, visited, t);
//            }
//        }
//
    ...
    List<Integer> pathfromStoT= new ArrayList();
     ...
     public void DFSUtil(int v,boolean[] visited , int t)
     {
